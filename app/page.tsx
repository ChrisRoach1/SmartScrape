          ...
          <section className='relative flex flex-1 flex-col items-center justify-center px-6 py-24 text-center'>
            <div className='relative z-10 mx-auto max-w-3xl space-y-6'>
              ...
              <h1 className='text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl'>
                Scrape smarter, <span className='text-primary'>not harder</span>
              </h1>

              {/* Subhead */}
              <p className='mx-auto max-w-xl text-lg text-muted-foreground'>
                Extract the data you need from any website in seconds. No code, no hassle — just results.
              </p>
              ...
              <div className='flex flex-wrap items-center justify-center gap-4 pt-2'>
                <SignedOut>
                  <SignUpButton>
                    <Button size='lg' className='rounded-full px-8 text-base font-semibold shadow-lg transition-shadow hover:shadow-xl'>
                      Get started free
